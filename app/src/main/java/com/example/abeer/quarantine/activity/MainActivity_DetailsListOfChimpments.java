    ...
    protected void onStart() {
        ...
        if (Details_json != null) {
            ...
            if (mWifi.isConnected()) {
                dataManger.SendVollyRequestJsonObjectGet(this, Request.Method.GET, ipadrass + ApiCall.UrlDetailsCheckRequest + Request_id+"&Committee_Type_Id="+Committee_Type_Id, new IDataValue() {                    @Override
...
//                            i.putExtra("_id", itemData.getRequest_Item_ID());
                        ...
                        public void comfirm_click(View view, DataForCardItems itemData) {
                            ...
                            i.putExtra("idReuestItem",itemData.getRequest_Item_ID());
                            i.putExtra("IsExportt",itemData.getIsExport());
                            i.putExtra(" Isplant",itemData.getIsplant());
                            i.putExtra("Item_Namee",itemData.getItem_Name());
                            i.putExtra("Item_Cat_Namee",itemData.getItem_Cat_Name());
                            startActivity(i);
