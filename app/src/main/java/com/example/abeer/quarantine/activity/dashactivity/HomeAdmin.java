...
public class HomeAdmin extends AppCompatActivity implements MyAdapter_Admin.customListener  {
    ...
    protected void onStart() {
        try {
            ...
            //   url_get_users = "http://192.168.8.100:8010/api/home/get_users";
                RequestQueue rq = Volley.newRequestQueue(this.getApplicationContext());
                JsonObjectRequest postrequest = new JsonObjectRequest(Request.Method.POST, url_get_users, null
    ...
    public void display_data(JSONObject s) throws JSONException {
        ...
        adapter.setCustomListner(HomeAdmin.this);
