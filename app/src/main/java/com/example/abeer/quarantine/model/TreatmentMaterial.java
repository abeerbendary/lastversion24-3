...
public class TreatmentMaterial {
    ...
    public TreatmentMaterial(String $id, int ID, String ar_Name, String en_Name, int treatmentType_ID, String chemicalComposition, String user_Updation_Date, int user_Deletion_Id, int user_Creation_Id, String user_Creation_Date, String user_Deletion_Date, int user_Updation_Id) {
        this.$id = $id;
        this.ID = ID;
        Ar_Name = ar_Name;
        En_Name = en_Name;
